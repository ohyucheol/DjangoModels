...
#### E. 지식재산권 등
다음 각 호는 '지식재산권 등'에 속하는 '물건'을 예시한 것이다.
1. 어문저작물, 영상저작물, 미술저작물 등 인간의 사상 또는 감정을 표현한 저작물
2. 특허권, 상표권, 디자인권 등 인간의 기술적 사상 등을 표현한 산업재산권
3. 위 1 내지 2호의 각 요소들의 조합으로 이루어진 게시물 등
